...
- [ ] Network and training logic implemented from scratch where the learning intent is clear (frameworks acceptable for comparison runs)
...
- [ ] Network logic implemented from scratch (frameworks only for reference comparison)
...
**Note**: This repository is Swamy PKV's personal Artificial Neural Networks study workspace. Keep changes aligned with the current week-based four-layer structure.
